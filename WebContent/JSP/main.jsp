...
<body>
	<div class="header">
		<div>
			<a href="index.html"><img src="<c:url value="/resources/images/logo.png" />" alt="Logo"></a>
		</div>
	...
	<div class="body">
		<div>
			<div class="header">
				...
				<div class="body">
					<div>
						<a href="index.html"><img src="image?recipeId=2" alt="Image"></a>
					</div>
					<ul>
					<c:forEach items="${sessionList}" var="recipe">
					<li>
					<div class=thubmnail>
						<a href="blog.html"><img src="image?recipeId=<c:out value="${recipe.recipeId}"/>" alt="Image"></a>
					</div>
						<div>
							<h2><a href="blog.html"><c:out value="${recipe.name}"/></a></h2>
							<p>
