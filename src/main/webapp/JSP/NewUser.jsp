						...
						<form:form action="newUserAdd" method="POST" modelAttribute="newUser" onsubmit="return validateEmail();">
							<center>
								<table>
									...
									<tr><td align="left">User Id:</td><td align="left"><form:input path="userId" id="userId" onblur="updateOutput(this.value)"/></td><td><font color="red"><c:out value="${userIdError}" /></font> </td></tr>
									<tr><td align="left">Password:</td><td align="left"><form:password path="userPassword"/></td><td><font color="red"><c:out value="${userPasswordError}" /><c:out value="${userPasswordMismatchError}"/></font></td></tr>
									<tr><td align="left">Confirm Password:</td><td align="left"><form:password path="userConfirmPassword"/></td><td><font color="red"><c:out value="${userConfirmPasswordError}" /></font></td></tr>
